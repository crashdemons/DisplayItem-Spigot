 ...
 * @author crash
 */
public abstract class DeferredEventSpamRecord {
     ...
     * parameters.
     */
    public boolean closeTo(DeferredEventSpamRecord record, long thresholdMs) {
     ...
     */
    public DeferredEventSpamRecord(DeferredChatEventParameters params) {
